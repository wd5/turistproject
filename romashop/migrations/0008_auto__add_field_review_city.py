...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Review.city'
        db.add_column('romashop_review', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Review.city'
        db.delete_column('romashop_review', 'city')
    ...
    models = {
        ...
        'romashop.callquery': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 17, 8, 32, 19, 200444)'}),
        ...
        'romashop.order': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 17, 8, 32, 19, 192741)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'romashop.review': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 17, 8, 32, 19, 198941)'}),
