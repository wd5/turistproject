...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Discount.is_active'
        db.add_column('romashop_discount', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Changing field 'Picture.position'
        db.alter_column('romashop_picture', 'position', self.gf('django.db.models.fields.PositiveIntegerField')())


    def backwards(self, orm):
        
        # Deleting field 'Discount.is_active'
        db.delete_column('romashop_discount', 'is_active')

        # Changing field 'Picture.position'
        db.alter_column('romashop_picture', 'position', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'romashop.callquery': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 2, 14, 3, 531692)'}),
        ...
        'romashop.featuredproduct': {
            'Meta': {'ordering': "['position']", 'object_name': 'FeaturedProduct'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'position': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['romashop.Product']", 'unique': 'True'})
        },
        'romashop.order': {
            'Meta': {'object_name': 'Order'},
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['romashop.Customer']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 2, 14, 3, 527561)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'romashop.popularproduct': {
            'Meta': {'ordering': "['position']", 'object_name': 'PopularProduct'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'position': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['romashop.Product']", 'unique': 'True'})
        },
        ...
        'romashop.review': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 2, 14, 3, 530953)'}),
