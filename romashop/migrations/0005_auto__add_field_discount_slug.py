...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Discount.slug'
        db.add_column('romashop_discount', 'slug', self.gf('django.db.models.fields.SlugField')(default='test', unique=True, max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Discount.slug'
        db.delete_column('romashop_discount', 'slug')
    ...
    models = {
        ...
        'romashop.callquery': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 9, 2, 20, 1, 473227)'}),
        ...
        'romashop.order': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 9, 2, 20, 1, 469063)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'romashop.review': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 9, 2, 20, 1, 472496)'}),
