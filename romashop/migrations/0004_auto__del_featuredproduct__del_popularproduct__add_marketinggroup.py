...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('romashop_featuredproduct')

        # Deleting model 'PopularProduct'
        db.delete_table('romashop_popularproduct')

        # Adding model 'MarketingGroup'
        db.create_table('romashop_marketinggroup', (
        ...
        db.send_create_signal('romashop', ['MarketingGroup'])

        # Adding M2M table for field products on 'MarketingGroup'
        db.create_table('romashop_marketinggroup_products', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('marketinggroup', models.ForeignKey(orm['romashop.marketinggroup'], null=False)),
            ('product', models.ForeignKey(orm['romashop.product'], null=False))
        ))
        db.create_unique('romashop_marketinggroup_products', ['marketinggroup_id', 'product_id'])


    def backwards(self, orm):
        
        # Adding model 'FeaturedProduct'
        db.create_table('romashop_featuredproduct', (
            ('position', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['romashop.Product'], unique=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('romashop', ['FeaturedProduct'])

        # Adding model 'PopularProduct'
        db.create_table('romashop_popularproduct', (
            ('position', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['romashop.Product'], unique=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('romashop', ['PopularProduct'])

        # Deleting model 'MarketingGroup'
        db.delete_table('romashop_marketinggroup')

        # Removing M2M table for field products on 'MarketingGroup'
        db.delete_table('romashop_marketinggroup_products')
    ...
    models = {
        ...
        'romashop.callquery': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 2, 19, 23, 608069)'}),
        ...
        'romashop.order': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 2, 19, 23, 603962)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'romashop.review': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 6, 2, 19, 23, 607354)'}),
