...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.cust_name'
        db.add_column('romashop_order', 'cust_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'Order.cust_email'
        db.add_column('romashop_order', 'cust_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75), keep_default=False)

        # Adding field 'Order.cust_phone'
        db.add_column('romashop_order', 'cust_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'Order.cust_city'
        db.add_column('romashop_order', 'cust_city', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'Order.cust_postcode'
        db.add_column('romashop_order', 'cust_postcode', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'Order.cust_address'
        db.add_column('romashop_order', 'cust_address', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.cust_name'
        db.delete_column('romashop_order', 'cust_name')

        # Deleting field 'Order.cust_email'
        db.delete_column('romashop_order', 'cust_email')

        # Deleting field 'Order.cust_phone'
        db.delete_column('romashop_order', 'cust_phone')

        # Deleting field 'Order.cust_city'
        db.delete_column('romashop_order', 'cust_city')

        # Deleting field 'Order.cust_postcode'
        db.delete_column('romashop_order', 'cust_postcode')

        # Deleting field 'Order.cust_address'
        db.delete_column('romashop_order', 'cust_address')
    ...
    models = {
        ...
        'romashop.callquery': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 17, 8, 42, 12, 428482)'}),
        ...
        'romashop.order': {
            ...
            'cust_address': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'cust_city': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'cust_email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'cust_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'cust_phone': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'cust_postcode': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['romashop.Customer']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 17, 8, 42, 12, 420073)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'romashop.review': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 17, 8, 42, 12, 426731)'}),
