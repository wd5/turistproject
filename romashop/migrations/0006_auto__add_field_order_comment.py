...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('romashop_order', 'comment', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.comment'
        db.delete_column('romashop_order', 'comment')
    ...
    models = {
        ...
        'romashop.callquery': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 9, 8, 31, 58, 384035)'}),
        ...
        'romashop.order': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 9, 8, 31, 58, 375023)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'romashop.review': {
            ...
            'datetime_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 9, 8, 31, 58, 382536)'}),
