...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('fgallery_album', 'cover', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='album_cover', null=True, to=orm['fgallery.Photo']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Album.cover'
        db.delete_column('fgallery_album', 'cover_id')
