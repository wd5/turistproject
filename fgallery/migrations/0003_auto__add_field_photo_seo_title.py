...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.seo_title'
        db.add_column('fgallery_photo', 'seo_title', self.gf('django.db.models.fields.CharField')(default='', max_length=70, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.seo_title'
        db.delete_column('fgallery_photo', 'seo_title')
