...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('fgallery_album', 'event_id')

        # Deleting field 'Video.event'
        db.delete_column('fgallery_video', 'event_id')


    def backwards(self, orm):
        
        # Adding field 'Album.event'
        db.add_column('fgallery_album', 'event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fevents.Event'], null=True, blank=True), keep_default=False)

        # Adding field 'Video.event'
        db.add_column('fgallery_video', 'event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fevents.Event'], null=True, blank=True), keep_default=False)
