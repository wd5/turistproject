...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fgallery_imagerelation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fgallery.Photo'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('fgallery', ['ImageRelation'])


    def backwards(self, orm):
        
        # Deleting model 'ImageRelation'
        db.delete_table('fgallery_imagerelation')
